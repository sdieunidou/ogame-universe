 ...
 */
final class Version20210324111406 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE spy (id INT AUTO_INCREMENT NOT NULL, server_id INT DEFAULT NULL, player_id INT DEFAULT NULL, planet_id INT DEFAULT NULL, api_key VARCHAR(255) NOT NULL, data LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', player_class INT DEFAULT NULL, activity INT DEFAULT NULL, coordinates VARCHAR(255) DEFAULT NULL, position INT DEFAULT NULL, system INT DEFAULT NULL, galaxy INT DEFAULT NULL, total_ship INT DEFAULT NULL, total_defense INT DEFAULT NULL, loot_percentage INT DEFAULT NULL, spy_at DATETIME DEFAULT NULL, metal INT DEFAULT NULL, crystal INT DEFAULT NULL, deuterium INT DEFAULT NULL, energy INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_AF10BF751844E6B7 (server_id), INDEX IDX_AF10BF7599E6F5DF (player_id), INDEX IDX_AF10BF75A25E9820 (planet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
