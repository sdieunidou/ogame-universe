...
class Alliance
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Server", inversedBy="alliances")
     */
    private $server;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Player", mappedBy="alliance")
     */
    private $players;
